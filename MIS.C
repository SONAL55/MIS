...
highvideo();
gotoxy(28,24);
cprintf("www.programmer2programmer.net");
...
TABLE1()
{
 ...
 textcolor(10+BLINK);
 highvideo();
 cprintf(" P2P - Medical Information System");
...
cprintf("Ú");
gotoxy(4,2);
cprintf("ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ ÄÄÄÄÄÄÄÄÄÄ");
gotoxy(77,3);
cprintf("¿");
for(a=4;a<20;a++)
{
...
textcolor(10);
gotoxy(6,10);
cprintf(" SORRY,RECORD NOT PRESENT");
}
gotoxy(22,21);
cprintf("WANT TO SEARCH ANOTHER RECORD(y/n)->");
fflush(stdin);
another=getche();
}while((another=='y')||(another=='Y'));
textbackground(6);
textcolor(10+BLINK);
gotoxy(17,23);
cprintf(" Press M to Return to Main Menu and Esc to Exit....");
a=getch();
if(a==109)
{
main();
...
cprintf("ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ");
 gotoxy(5,20);
...
cprintf("Ù");
gotoxy(4,20);
cprintf("ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ ÄÄÄÄÄÄÄÄ");
...
gotoxy(6,8);
fflush(stdin);
cprintf("Patient Name->%s",out.patient);
gotoxy(6,10);
cprintf("Patient Age->%d",out.age);
gotoxy(6,12);
fflush(stdin);
cprintf("Patient Sex->%s",out.sex1);
gotoxy(6,14);
fflush(stdin);
cprintf("Medicine given->%s",out.medicine);
}
}
textcolor(10);
highvideo();
...
textbackground(4);
gotoxy(1,1);
cprintf("              WELCOME TO MEDICAL INFORMATION SYSTEM HELP "  );
textcolor(10);
textbackground(1);
highvideo();
gotoxy(2,3);
cprintf("This system is built using mouse programming and drop down menus.");
gotoxy(2,4);
cprintf("In this system you can Enter 'n' No. of Records.");
gotoxy(2,6);
cprintf("1First option FILE can be selected by clicking on it.");
/* Click  event will show a drop down menu,in which you can select any one of theoptions.First       option is " ADD EMP .RECORD " which is used to
add details about employee.The   second option is NEW ENTRY which is
used to enter the new record about        patient.The third option is
"SEARCH RECORD" which is used to search the record  of any
patient."); */
gotoxy(2,13);
cprintf("2Second menu is EDIT,can be selected by clicking on  it.");
/*the
...
");*/
gotoxy(2,18);
cprintf("3Third menu is HELP,which provide you information about using the system.");
gotoxy(2,20);
...
highvideo();
gotoxy(2,25);
cprintf("              Press Esc key to quit or M to return to Main Menu...            ");
a=getch();
if(a==109)
{
for(a=25;a>0;a--)
